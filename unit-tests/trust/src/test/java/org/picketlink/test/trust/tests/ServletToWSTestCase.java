...
public class ServletToWSTestCase
{
   ...
   public void testServlet2WS() throws Exception
   {
      ...
      PostMethod post = new PostMethod("http://" + System.getProperty("test.hosts.bind.address", "localhost") + ":" + System.getProperty("test.server.port", "28080")
            + "/binary-test/TestWSInvokingServlet");
